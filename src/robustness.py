...
from .family_evaluator import CostModel, DEFAULT_INITIAL_CAPITAL, backtest_family


def run_robustness_tests(
    data_splits: dict[str, list[dict[str, Any]]],
    ...
    baseline_oos, _ = backtest_family(data_splits["oos"], family, base_cost, "oos", initial_capital=initial_capital)
    elevated_fee_oos, _ = backtest_family(data_splits["oos"], family, stress_fee, "oos_fee", initial_capital=initial_capital)
    elevated_slip_oos, _ = backtest_family(data_splits["oos"], family, stress_slip, "oos_slip", initial_capital=initial_capital)
    ...
    for bump in [0.9, 1.1]:
        ...
        _, m = backtest_family(data_splits["validation"], perturbed, base_cost, f"perturb_{bump}", initial_capital=initial_capital)
